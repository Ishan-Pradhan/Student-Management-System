...
public class UserDAO {
    ...
    public String returnQueryToGetColumnNames(){
        String query = "SELECT id,fullname,username,address,contact,email FROM user";
        return query;
    }
...
//    public void updataUserName(String oldusername,String newusername,String password){
//        try {
//            
//        } catch (Exception e) {
//        }
